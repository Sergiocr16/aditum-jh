...
public class ProveedorResourceIntTest {
    ...
    public void createProveedor() throws Exception {
        ...
        assertThat(testProveedor.getEmpresa()).isEqualTo(DEFAULT_EMPRESA);
        assertThat(testProveedor.getResponsable()).isEqualTo(DEFAULT_RESPONSABLE);
    ...
    public void updateProveedor() throws Exception {
        ...
        Proveedor testProveedor = proveedorList.get(proveedorList.size() - 1);
        assertThat(testProveedor.getEmpresa()).isEqualTo(UPDATED_EMPRESA);
        assertThat(testProveedor.getResponsable()).isEqualTo(UPDATED_RESPONSABLE);
