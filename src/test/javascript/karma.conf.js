...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/cloudinary_ng/js/angular.cloudinary.js',
            'src/main/webapp/bower_components/angular-pdf-viewer/dist/angular-pdf-viewer.min.js',
