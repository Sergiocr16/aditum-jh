(function () {
    ...
    angular
        .module('aditumApp')
        .controller('Dashboard1Controller', Dashboard1Controller);

    Dashboard1Controller.$inject = ['$scope', '$rootScope', 'Principal', 'LoginService', '$state', 'Dashboard','globalCompany','Modal'];

    function Dashboard1Controller($scope, $rootScope, Principal, LoginService, $state, Dashboard,globalCompany,Modal) {
        var vm = this;
