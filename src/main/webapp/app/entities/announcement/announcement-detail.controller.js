(function () {
    ...
    AnnouncementDetailController.$inject = ['$scope', '$rootScope', '$stateParams', 'previousState', 'entity', 'Announcement', 'Company', 'Modal', 'companyUser', 'ParseLinks', 'CommonMethods', 'globalCompany'];

    function AnnouncementDetailController($scope, $rootScope, $stateParams, previousState, entity, Announcement, Company, Modal, companyUser, ParseLinks, CommonMethods, globalCompany) {
        var vm = this;
        moment.locale("es");

        vm.announcement = entity;
        vm.previousState = previousState.name;
        vm.announcement.showDate = moment(vm.announcement.publishingDate).fromNow();
        vm.announcement.comments = [];
        vm.announcement.showingComments = false;
        vm.announcement.currentComment = {comment: ""};
        vm.announcement.showingCommentForm = false;
        vm.announcement.commentsPage = 0;
