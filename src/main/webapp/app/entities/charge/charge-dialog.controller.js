(function() {
    ...
    ChargeDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Charge', 'House'];

    function ChargeDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Charge, House) {
        var vm = this;
