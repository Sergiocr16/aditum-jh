(function () {
    ...
    OfficerARDialogController.$inject = ['$rootScope', '$state', 'Principal', '$timeout', 'CommonMethods', '$scope', '$stateParams', '$q', 'DataUtils', 'entity', 'Officer', 'User', 'Company', 'SaveImageCloudinary', 'PadronElectoral', 'globalCompany', 'Modal', 'WSOfficer'];

    function OfficerARDialogController($rootScope, $state, Principal, $timeout, CommonMethods, $scope, $stateParams, $q, DataUtils, entity, Officer, User, Company, SaveImageCloudinary, PadronElectoral, globalCompany, Modal, WSOfficer) {
        var vm = this;
        vm.isReady = false;
        var fileImage = null;
