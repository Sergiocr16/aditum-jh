(function () {
    ...
    OfficerARController.$inject = ['User', '$state', 'CommonMethods', 'DataUtils', 'Officer', 'ParseLinks', 'AlertService', 'paginationConstants', 'pagingParams', 'Principal', '$rootScope', 'globalCompany', 'Modal', 'WSDeleteEntity', 'WSOfficer'];

    function OfficerARController(User, $state, CommonMethods, DataUtils, Officer, ParseLinks, AlertService, paginationConstants, pagingParams, Principal, $rootScope, globalCompany, Modal, WSDeleteEntity, WSOfficer) {
