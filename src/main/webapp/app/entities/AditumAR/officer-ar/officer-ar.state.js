(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('officer-ar', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/officer-ar/officer-ars.html',
        ...
        .state('officer-ar-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/officer-ar/officer-ar-detail.html',
        ...
        .state('officer-ar-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/officer-ar/officer-ar-dialog.html',
        ...
        .state('officer-ar.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/officer-ar/officer-ar-delete-dialog.html',
