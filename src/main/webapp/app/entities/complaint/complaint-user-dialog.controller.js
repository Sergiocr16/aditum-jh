(function() {
    ...
    ComplaintUserDialogController.$inject = ['$timeout', '$scope', '$stateParams','$rootScope','$state', 'companyUser', 'Complaint'];

    function ComplaintUserDialogController ($timeout, $scope, $stateParams, $rootScope, $state, companyUser, Complaint) {
        var vm = this;
