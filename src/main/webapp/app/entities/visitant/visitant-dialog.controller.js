(function() {
    ...
    VisitantDialogController.$inject = ['$timeout', '$interval', '$scope', '$stateParams', 'Visitant', 'House', 'Company', 'Principal', '$rootScope', 'CommonMethods'];

    function VisitantDialogController($timeout, $interval, $scope, $stateParams, Visitant, House, Company, Principal, $rootScope, CommonMethods) {
        var vm = this;
