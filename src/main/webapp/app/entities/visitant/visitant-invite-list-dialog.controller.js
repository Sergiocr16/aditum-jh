(function() {
    ...
    VisitantInviteListDialogController.$inject = ['$state','$timeout', '$interval', '$scope', '$stateParams', 'Visitant', 'House', 'Company', 'Principal', '$rootScope', 'CommonMethods','WSVisitor','WSDeleteEntity'];

    function VisitantInviteListDialogController($state,$timeout, $interval, $scope, $stateParams, Visitant, House, Company, Principal, $rootScope, CommonMethods,WSVisitor,WSDeleteEntity) {
        var vm = this;
        ...
        angular.element(document).ready(function() {
         ...
         var visitor = {id:null,name:null,lastname:null,secondlastname:null,identificationnumber:null,arrivaltime:null,invitationstaringtime:null,invitationlimittime:null,licenseplate:null,isinvited:1,responsableofficer:null,houseId:$rootScope.companyUser.houseId,companyId:$rootScope.companyId}
