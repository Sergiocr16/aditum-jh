...
public class HouseService {
    ...
    private BalanceDTO getBalanceByHouse(String currency, Long houseId) {
        ...
        double total = (Double.parseDouble(balance.getCommonAreas())
            + Double.parseDouble(balance.getExtraordinary())
            + Double.parseDouble(balance.getMaintenance())
            + Double.parseDouble(balance.getMulta())
            + Double.parseDouble(balance.getWaterCharge()));
    ...
    private double getBalanceByType(String currency, Long houseId, int type) {
        ...
        double ammountCharges = charges.stream().mapToDouble(o -> Double.parseDouble(o.getPendiente())).sum();
        if (type != 1) {
    ...
    private double getTotalBalanceByHouse(String currency, Long houseId) {
        ...
        double ammountChargesMaint = chargesMaint.stream().mapToDouble(o -> Double.parseDouble(o.getPendiente())).sum();
        List<ChargeDTO> chargesExtra = this.chargeService.findBeforeDateAndHouseAndTypeAndState(currency, today, houseId, 2, 1);
        double ammountChargesExtra = chargesExtra.stream().mapToDouble(o -> Double.parseDouble(o.getPendiente())).sum();
        List<ChargeDTO> chargesAreas = this.chargeService.findBeforeDateAndHouseAndTypeAndState(currency, today, houseId, 3, 1);
        double ammountChargesArea = chargesAreas.stream().mapToDouble(o -> Double.parseDouble(o.getPendiente())).sum();
        List<ChargeDTO> chargesMulta = this.chargeService.findBeforeDateAndHouseAndTypeAndState(currency, today, houseId, 5, 1);
        double ammountChargesMulta = chargesMulta.stream().mapToDouble(o -> Double.parseDouble(o.getPendiente())).sum();
        List<ChargeDTO> chargesWater = this.chargeService.findBeforeDateAndHouseAndTypeAndState(currency, today, houseId, 6, 1);
        double ammountChargesWater = chargesWater.stream().mapToDouble(o -> Double.parseDouble(o.getPendiente())).sum();
