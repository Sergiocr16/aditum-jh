...
public class WaterConsumptionResource {
    ...
    @Timed
    public void billWaterConsumption(@PathVariable Long companyId, @PathVariable Long wCid, @PathVariable ZonedDateTime date, @PathVariable Boolean sendEmail, @PathVariable Boolean autoCalculated, @PathVariable String concept) {
        log.debug("REST request to get all WaterConsumptions");
        ...
        chargeService.createWaterCharge(this.waterConsumptionService.findOne(wCid), date, administrationConfigurationDTO, sendEmail, autoCalculated, concept);
    }


    @GetMapping("/water-consumptions/bill-all/{companyId}/{date}/{chargeDate}/{sendEmail}/{autoCalculated}/{concept}")
    @Timed
    public List<WaterConsumptionDTO> billAllWaterConsumption(@PathVariable Long companyId, @PathVariable ZonedDateTime date, @PathVariable ZonedDateTime chargeDate, @PathVariable Boolean sendEmail, @PathVariable Boolean autoCalculated, @PathVariable String concept) {
        log.debug("REST request to get all WaterConsumptions");
        AdministrationConfigurationDTO administrationConfigurationDTO = this.administrationConfigurationService.findOneByCompanyId(companyId);
